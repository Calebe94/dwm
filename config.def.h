...
static const char *play_pause_media[] = {"playerctl", "-a", "play-pause", NULL};
static const char *next_media[] = {"playerctl", "-a", "next", NULL};
static const char *prev_media[] = {"playerctl", "-a", "previous", NULL};
